...
def init_db():
    ...
    """
    from src.server.db.tables import advisor_chat, assets, budget, cash_flow, insights, plaid_liabilities, plaid_transactions, portfolio_snapshot, transaction, user, wallet  # noqa: F401
